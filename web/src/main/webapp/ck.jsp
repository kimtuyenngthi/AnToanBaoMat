...
<div class="section">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!-- /shop -->
      <!-- /shop -->
      <h1>VUI LÒNG CHUYỂN VÀO TÀI KHOẢN SAU ĐÂY:</h1>
      <h1>NGÂN HÀNG BIDV: 102566565656 </h1>
      <h1>NGƯỜI THỤ HƯỞNG: NHUẬN</h1>
      <h1>SAU KHI CHUYỂN XONG CỬA HÀNG SẼ GỌI XÁC NHẬN XIN CHỜ NHÉ!!</h1>
    </div>
    <!-- /row -->
  </div>
  <!-- /container -->
